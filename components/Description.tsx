export default function Description() {
  return (
    <div>
      ...
      <ol>
        <li>
          <strong>作業を25分間集中して行う（ポモドーロ）</strong>{' '}
          タスクに取り組む時間を25分に設定します。この間、他のことに気を取られずに集中して取り組みます。
        </li>
        <li>
          <strong>5分間の休憩を取る</strong>{' '}
          25分の作業後に、5分間の休憩を取ります。リラックスしたり、ストレッチをしたりしてリフレッシュします。
        </li>
        <li>
          <strong>4ポモドーロごとに長めの休憩を取る</strong>{' '}
      ...
      <ul>
        ...
        <li>
          <strong>作業の計画と進捗の可視化：</strong>{' '}
          ポモドーロを使うことで、作業の進捗を確認しやすくなり、日々の計画を立てやすくなります。
        </li>
        <li>
          <strong>モチベーションの維持：</strong>{' '}
          25分の作業という短い時間なので、モチベーションを持続しやすいです。
        </li>
      </ul>
    </div>
  );
