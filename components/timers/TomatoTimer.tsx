    ...
    <>
        <div className='flex flex-col items-center justify-center p-4'>
            ...
            <div className='relative flex justify-center items-center'>
                ...
                <div className='absolute flex justify-center pt-28' style={{ width: '100%', height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <div className='text-xl font-bold'><Timer size={size}/></div>
                </div>
            </div>
            </div>
        </div>
